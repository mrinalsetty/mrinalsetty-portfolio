          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="flex flex-col items-center space-y-4">
              <div className="relative">
                ...
                <Image
                  ...
                  width={280}
                  height={280}
                  className="relative w-64 h-64 sm:w-72 sm:h-72 rounded-full object-cover border-2 border-sky-500/30 shadow-xl"
                  priority
                />
              </div>
            ...
            <div className="space-y-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group relative overflow-hidden rounded-lg bg-linear-to-r from-amber-600 to-orange-700 px-4 py-3 text-center text-sm font-medium text-white transition-all duration-200 hover:from-amber-500 hover:to-orange-600 hover:shadow-lg hover:scale-[1.02] cursor-hover block"
              >
                <span className="relative z-10 flex items-center justify-center gap-2">
                  <svg
                    className="w-4 h-4"
            ...
            <div className="modern-card p-6">
              ...
              <div className="flex flex-wrap gap-3">
                {personalInfo.quickFacts.map((fact, index) => (
                  <span
                    key={index}
                    className="px-4 py-2 bg-blue-500/10 rounded-full text-sm font-medium text-blue-300 
